		...
		<div class="arriv-top">
			<div class="col-md-6 arriv-left">
				...
				<div class="arriv-info">
					<h3>NEW ARRIVALS</h3>
					<p>GET THE NEW ARIRIVAL BRANDS CLOTHING</p>
					<div class="crt-btn">
			...
			<div class="col-md-6 arriv-right">
				<img src="images/electronics.jpg" class="img-responsive" style="width:556px; height:387px;" alt="">
				<div class="arriv-info">
					<div class="nonBlack"><h3>Popular Electronics</h3>
					<p>Get the Most Popular Electronics & Gagdets</p>
					<div class="crt-btn">
						<a href="details.html">SHOP NOW</a></div>
					</div>
				</div>
			</div>
